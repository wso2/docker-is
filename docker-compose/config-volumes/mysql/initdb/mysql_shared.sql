...
CREATE TABLE IF NOT EXISTS REG_PATH(
      ...
      REG_PATH_VALUE VARCHAR(750) CHARACTER 
SET latin1 COLLATE latin1_general_cs NOT NULL,
...
CREATE TABLE UM_MODULE_ACTIONS(
      ...
      FOREIGN KEY (UM_MODULE_ID) REFERENCES UM_MODULE(UM_ID) ON 
DELETE CASCADE
) ENGINE INNODB;
...
CREATE TABLE UM_ROLE_PERMISSION (
      ...
      FOREIGN KEY (UM_PERMISSION_ID, UM_TENANT_ID) REFERENCES UM_PERMISSION(UM_ID, UM_TENANT_ID) ON 
DELETE CASCADE,
      FOREIGN KEY (UM_DOMAIN_ID, UM_TENANT_ID) REFERENCES UM_DOMAIN(UM_DOMAIN_ID, UM_TENANT_ID) ON 
   DELETE CASCADE,
      PRIMARY KEY (UM_ID, UM_TENANT_ID)
) ENGINE INNODB;
...
CREATE TABLE UM_SHARED_USER_ROLE(
      ...
      FOREIGN KEY(UM_ROLE_ID, UM_ROLE_TENANT_ID) REFERENCES UM_ROLE(UM_ID, UM_TENANT_ID) ON 
DELETE CASCADE,
      FOREIGN KEY(UM_USER_ID, UM_USER_TENANT_ID) REFERENCES UM_USER(UM_ID, UM_TENANT_ID) ON 
   DELETE CASCADE
) ENGINE INNODB;
...
CREATE TABLE UM_ACCOUNT_MAPPING(
      ...
      FOREIGN KEY (UM_TENANT_ID) REFERENCES UM_TENANT(UM_ID) ON 
DELETE CASCADE,
      PRIMARY KEY (UM_ID)
) ENGINE INNODB;
...
CREATE TABLE UM_HYBRID_USER_ROLE(
      ...
      FOREIGN KEY (UM_ROLE_ID, UM_TENANT_ID) REFERENCES UM_HYBRID_ROLE(UM_ID, UM_TENANT_ID) ON 
DELETE CASCADE,
      FOREIGN KEY (UM_DOMAIN_ID, UM_TENANT_ID) REFERENCES UM_DOMAIN(UM_DOMAIN_ID, UM_TENANT_ID) ON 
   DELETE CASCADE,
      PRIMARY KEY (UM_ID, UM_TENANT_ID)
