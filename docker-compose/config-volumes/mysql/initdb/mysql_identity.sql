...
CREATE TABLE IF NOT EXISTS IDN_CLAIM_MAPPED_ATTRIBUTE (
  ...
  CONSTRAINT USER_STORE_DOMAIN_CONSTRAINT UNIQUE (
    LOCAL_CLAIM_ID,
...
VALUES (
    ...
    'IDP_TEMPLATE',
    'Template type to uniquely identify IDP templates'
  ),
  (
...
CREATE TABLE IF NOT EXISTS IDN_USER_FUNCTIONALITY_PROPERTY (
  ...
  PRIMARY KEY (ID),
  CONSTRAINT IDN_USER_FUNCTIONALITY_PROPERTY_CONSTRAINT UNIQUE (
    USER_ID,
    TENANT_ID,
    FUNCTIONALITY_ID,
    PROPERTY_NAME
...
CREATE INDEX IDX_AT_CK_AU ON IDN_OAUTH2_ACCESS_TOKEN(
  CONSUMER_KEY_ID,
  AUTHZ_USER,
  TOKEN_STATE,
  USER_TYPE
...
CREATE INDEX IDX_AT_AU_TID_UD_TS_CKID ON IDN_OAUTH2_ACCESS_TOKEN(
  AUTHZ_USER,
  TENANT_ID,
  USER_DOMAIN,
  TOKEN_STATE,
...
CREATE INDEX IDX_AT_AU_CKID_TS_UT ON IDN_OAUTH2_ACCESS_TOKEN(
  AUTHZ_USER,
  CONSUMER_KEY_ID,
  TOKEN_STATE,
  USER_TYPE
...
CREATE INDEX IDX_AT_CKID_AU_TID_UD_TSH_TS ON IDN_OAUTH2_ACCESS_TOKEN(
  CONSUMER_KEY_ID,
  AUTHZ_USER,
  TENANT_ID,
  USER_DOMAIN,
