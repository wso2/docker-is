...
This section defines the step-by-step instructions to build an [Ubuntu](https://hub.docker.com/_/ubuntu/) based Docker image for WSO2 Identity Server 5.7.0.
...
- Download [WSO2 Identity Server v5.7.0](https://wso2.com/identity-and-access-management/previous-releases) 
