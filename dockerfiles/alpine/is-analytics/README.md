...
This section defines the step-by-step instructions to build an [Alpine OpenJDK](https://hub.docker.com/_/openjdk/) Docker image for WSO2 Identity Server Analytics 5.6.0.
