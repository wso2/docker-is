...
This section defines the step-by-step instructions to build the Docker image for WSO2 Identity Server Analytics 5.4.1.
...
In WSO2 Identity Server Analytics 5.4.1 product distribution, `carbon.xml` configuration file <br>
...
wso2is-analytics:5.4.1
```

>In here, <TARGET_CONFIGS> refers to /home/wso2carbon/wso2is-analytics-5.4.1/repository/conf folder of the container.
