...
based Docker image for WSO2 Identity Server `7.2.0` with [Post-Quantum TLS support](https://is.docs.wso2.com/en/7.2.0/deploy/security/configure-post-quantum-tls/).
