...
test -d ${volumes}/repository/components/dropins && cp -r ${volumes}/repository/components/dropins/* ${WSO2_SERVER_HOME}/dropins
test -d ${volumes}/repository/components/extensions && cp -r ${volumes}/repository/components/extensions/* ${WSO2_SERVER_HOME}/extensions
test -d ${volumes}/repository/components/lib && cp -r ${volumes}/repository/components/lib/* ${WSO2_SERVER_HOME}/lib
